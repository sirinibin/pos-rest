...
func (store *Store) SearchStockTransferHistory(w http.ResponseWriter, r *http.Request) (models []ProductStockTransferHistory, criterias SearchCriterias, err error) {
	...
	ParseTextSearch(r, &criterias, "search[from_warehouse_code]", "from_warehouse_code")

	ParseTextSearch(r, &criterias, "search[to_warehouse_code]", "to_warehouse_code")
	...
	if err = ParseObjectIDFilter(r, &criterias, "search[stocktransfer_id]", "stocktransfer_id"); err != nil {
		return models, criterias, err
	}
