...
func main() {
	...
	router.HandleFunc("/v1/store/list", controller.ListStoreList).Methods("GET")
	router.HandleFunc("/v1/store/{id}/backup/size", controller.GetStoreBackupSize).Methods("GET")
	router.HandleFunc("/v1/store/{id}/backup/start", controller.StartStoreBackup).Methods("POST")
	router.HandleFunc("/v1/store/{id}/backup/progress", controller.GetStoreBackupProgress).Methods("GET")
	router.HandleFunc("/v1/store/{id}/backup/file", controller.DownloadStoreBackupFile).Methods("GET")
	...
	router.HandleFunc("/v1/store/{id}/duplicate-with-products-no-images/size", controller.GetStoreDuplicateWithProductsNoImagesSize).Methods("GET")
	router.HandleFunc("/v1/store/{id}/duplicate-with-products-no-images/start", controller.StartStoreDuplicateWithProductsNoImages).Methods("POST")
	router.HandleFunc("/v1/store/{id}/duplicate-with-products-no-images/progress", controller.GetStoreDuplicateWithProductsNoImagesProgress).Methods("GET")
	router.HandleFunc("/v1/store/{id}/duplicate-without-data/size", controller.GetStoreDuplicateWithoutDataSize).Methods("GET")
	router.HandleFunc("/v1/store/{id}/duplicate-without-data/start", controller.StartStoreDuplicateWithoutData).Methods("POST")
	router.HandleFunc("/v1/store/{id}/duplicate-without-data/progress", controller.GetStoreDuplicateWithoutDataProgress).Methods("GET")
	...
	*/
	...
	s.Every(1).Hour().Do(func() {
		if err := models.ProcessScheduledPermanentDeletions(); err != nil {
